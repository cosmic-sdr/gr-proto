...
private:
	...
	simde__m128i  d_metric0[4] __attribute__  ((aligned(16)));
	simde__m128i  d_metric1[4] __attribute__  ((aligned(16)));
	simde__m128i  d_path0[4] __attribute__  ((aligned(16)));
	simde__m128i  d_path1[4] __attribute__  ((aligned(16)));
	...
	void viterbi_butterfly2_sse2(unsigned char *symbols,
			simde__m128i  m0[], simde__m128i  m1[], simde__m128i p0[], simde__m128i p1[]);
	unsigned char viterbi_get_output_sse2(simde__m128i  *mm0,
			simde__m128i  *pp0, int ntraceback, unsigned char *outbuf);
};
