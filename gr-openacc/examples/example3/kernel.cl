...
__kernel void __attribute__((reqd_work_group_size(64, 1, 1))) accLog_kernel_kernel0(__global float * in1, __global float * out, float k_val, float n_val, int noutput_items)
{
int lwpriv__i;
lwpriv__i=get_global_id(0);
if (lwpriv__i<noutput_items)
